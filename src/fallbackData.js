...
export const fallbackLabState = {
  ...
  runs: [
    { name: "AI Momentum Pro", version: "v2.3.1", run: "Run 42", status: "Running", modelProfile: "local_policy", concurrency: 2, return7d: 8.42, maxDd: -4.62, winRate: 61.3, lastRun: "14:32:18" },
    { name: "AI Mean Reversion", version: "v1.8.0", run: "Run 15", status: "Paper", modelProfile: "codex_cli", concurrency: 1, return7d: 3.27, maxDd: -2.11, winRate: 55.7, lastRun: "14:28:05" },
    { name: "AI Breakout Alpha", version: "v1.5.2", run: "Run 27", status: "Shadow", modelProfile: "local_policy", concurrency: 3, return7d: 6.91, maxDd: -5.08, winRate: 58.9, lastRun: "14:31:40" },
    { name: "Funding Arbitrage", version: "v1.2.4", run: "Run 9", status: "Stopped", modelProfile: "claude_cli", concurrency: 1, return7d: 1.12, maxDd: -1.35, winRate: 64.2, lastRun: "12:15:33" },
    { name: "Multi-Factor Trend", version: "v2.0.0", run: "Run 33", status: "Paper", modelProfile: "compatible_endpoint", concurrency: 2, return7d: 5.38, maxDd: -3.21, winRate: 60.8, lastRun: "14:22:11" },
    { name: "Volatility Breakout", version: "v1.6.1", run: "Run 18", status: "Shadow", modelProfile: "local_policy", concurrency: 2, return7d: 2.48, maxDd: -2.92, winRate: 53.1, lastRun: "14:20:07" },
    { name: "Pairs Trading AI", version: "v1.3.7", run: "Run 11", status: "Stopped", modelProfile: "codex_cli", concurrency: 1, return7d: -0.31, maxDd: -1.98, winRate: 48.6, lastRun: "11:05:22" },
    { name: "Regime Rotation", version: "v2.1.0", run: "Run 21", status: "Shadow", modelProfile: "local_policy", concurrency: 4, return7d: 4.02, maxDd: -4.11, winRate: 57.3, lastRun: "14:30:44" },
  ],
  candles: candles(),
